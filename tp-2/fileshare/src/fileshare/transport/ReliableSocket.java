...
public class ReliableSocket implements AutoCloseable
{
    private static class OutgoingConnectionAttempt
    {
        ...
        /**
         * Returns empty if rejected, else the remote connection identifier.
         *
     ...
     */
    private final AtomicInteger lastLocalConnectionId;
    ...
    public ReliableSocket(int localPort) throws IOException
    {
        ...
        this.lastLocalConnectionId = new AtomicInteger(0);
    }
        ...
        ) throws IOException
    {
        ...
        final var localConnectionId =
            (short) this.lastLocalConnectionId.incrementAndGet();
        ...
        this.outgoingConnectionAttempts.add(connectionAttempt);

        for (int i = 0; i < Config.MAX_CONNECTION_RETRIES; ++i)
        {
            // send connection request

            Segments.sendConn(packetBuffer, remoteEndpoint, localConnectionId);
            ...
            else
            {
                ...
                Segments.sendConnAcceptAck(
                    packetBuffer, remoteEndpoint, remoteConnectionId.getAsInt()
                );

                // unregister connection attempt

                this.outgoingConnectionAttempts.remove(connectionAttempt);
